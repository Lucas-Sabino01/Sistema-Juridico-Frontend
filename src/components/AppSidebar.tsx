import { Scale, LayoutDashboard, CalendarDays, Settings, Archive, PieChart, Bell, FileSpreadsheet, ClipboardList, FileText } from "lucide-react";
...
const items = [
  ...
  { title: "Extrator de Audiência", url: "/extrator-audiencia", icon: FileText },
